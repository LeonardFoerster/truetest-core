...
**Qualifying rules** (from docs/governance/01-prod.md):
...
**Current count**: 0 / 15 qualifying (as of 2026; Phase 0 collection was paused during priority work on the monte-carlo branch — MC changes did not alter P0 gates or the live safety surface). Monte Carlo simulation capabilities (integrated from the monte-carlo branch) are available for research and strategy robustness (see root `docs/governance/03-todo.md` MC-* or docs/todos/03-MC-simulation.md and `docs/reference/01-instructions.md`). The 15 qualifying sessions and Phase 0/1 gates defined in `docs/governance/01-prod.md` remain the requirements for any increase in live capital.

**Next actions**: See root `docs/governance/03-todo.md` (high-level; P0-01..P0-04 + MC-*; Phase 0 collection notes; MC does not relax P0 gates) or precise docs/todos/01-P0-phase0.md#P0-01 (and docs/todos/03-MC-simulation.md) and `docs/governance/01-prod.md` (exit criteria + full ritual). The volatility classifier and session scripts remain available. Phase 0 collection was paused during priority work on the monte-carlo branch (MC changes did not alter P0 gates or the live safety surface); 0/15 qualifying.
