...
**Aspirational / missing dirs & files** (referenced in docs/README, instructions, AGENTS.md, todo, reports, etc.; do not exist yet; use explicit planned language):
