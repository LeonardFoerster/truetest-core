...
**See**: docs/todos/00-OVERVIEW.md for full rules, reference format (e.g. "Addresses docs/todos/02-P1-freeze.md#P1-02"), maintenance, and mapping. High-level also in thin `docs/governance/03-todo.md`. Frozen list here is single source of truth for tasks (sync with check script + prereq + prod + CLAUDE).
