...
dashboard_snapshot build_snapshot()
{
    ...
    s.strategies = {
        {"MOM-XBT",   28940.55, 184, 113, 0.612, 2.31, 41200, 17840, 2, 2},
        {"MR-ETH",    12184.20, 241, 140, 0.583, 1.74, 28600, 16420, 1, 1},
        {"BASIS-SOL", -3420.18, 96,  46,  0.476, 0.91, 14200, 15620, 1, 1},
        {"STAT-ARB",  9601.31,  312, 208, 0.668, 2.02, 19300, 9560,  0, 0},
    };
